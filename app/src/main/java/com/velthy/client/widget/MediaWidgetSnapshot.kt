 ...
 * connecting one means starting [PlaybackService][com.velthy.client.playback.PlaybackService]
 * just to find out what to draw. So the service writes here whenever the answer
 * changes ([publishWidgetState][com.velthy.client.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
         ...
         * process by
         * [VelthyApplication.onCreate][com.velthy.client.VelthyApplication],
        ...
        private fun prefs(context: Context) =
            context.getSharedPreferences("velthy_widget", Context.MODE_PRIVATE)
