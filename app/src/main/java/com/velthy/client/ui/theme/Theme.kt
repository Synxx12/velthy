...
private val DarkColors = darkColorScheme(
    ...
    primaryContainer = Color(0xFF381014),
...
private val LightColors = lightColorScheme(
    primary = AccentRed,
    onPrimary = Color.White,
    primaryContainer = Color(0xFFFFD8DC),
    onPrimaryContainer = Color(0xFF381014),
...
private val VelthyTypography = Typography(
