...
fun SpotifyCanvasAuthScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "To enable Spotify Canvas motion artwork integration, provide your 'sp_dc' session cookie from Spotify.",
            ...
            Button(
                onClick = { 
                    AppSettings.setSpotifySpdcToken(tokenInput.trim().ifEmpty { null })
                    onNavigateUp()
                },
