 ...
 */
package com.velthy.client.ui.components.backdrop.internal
...
internal class InverseLayerScope : GraphicsLayerScope {
    ...
    // `blendMode`/`colorFilter` are members of GraphicsLayerScope on the
    // Compose version this was vendored against; the one this app builds with
    // has not grown them yet, so they are plain properties here rather than
    // overrides. Nothing outside this file reads them.
