 ...
 */
package com.velthy.client.ui.components.backdrop.effects
...
import com.velthy.client.ui.components.backdrop.BackdropEffectScope
import com.velthy.client.ui.components.backdrop.internal.RoundedRectRefractionShaderString
import androidx.compose.ui.geometry.isSpecified
import com.velthy.client.ui.components.backdrop.internal.RoundedRectRefractionWithDispersionShaderString
import com.velthy.client.ui.components.backdrop.internal.RuntimeShaderEffect
import com.velthy.client.ui.components.backdrop.isRuntimeShaderSupported
...
fun BackdropEffectScope.lens(
    ...
    // The effects block is applied once as soon as the modifier attaches, which
    // is before the node has been measured — `size` is unspecified then, and
    // reading it for the corner radii throws. Reading it here still registers
    // the observation, so layout giving the node a real size re-runs this and
    // the lens lands; the first pass simply has nothing to do.
