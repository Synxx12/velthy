 ...
 * [StreamResolver][com.velthy.client.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.velthy.client.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.velthy.client.playback.QualityUpgrade.lookAgain].
 ...
 * [AppSettings][com.velthy.client.data.settings.AppSettings] and is turned
