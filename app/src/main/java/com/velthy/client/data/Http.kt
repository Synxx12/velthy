 ...
 * `next`-endpoint fetches, [ChunkedDataSource][com.velthy.client.playback.ChunkedDataSource]
 * and [AudioCache][com.velthy.client.playback.AudioCache]'s multi-megabyte
