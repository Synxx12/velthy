...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.velthy.client.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun declaredFormat(mediaId: String?): StreamFormat? {
        ...
        return declared[key]
            ?: com.velthy.client.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.velthy.client.playback.PlaybackService] — which the
     ...
     *
     * @see com.velthy.client.playback.QualityUpgrade.forgetLastSession for the
