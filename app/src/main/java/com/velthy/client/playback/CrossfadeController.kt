...
import com.velthy.client.data.settings.SmartAnalysis
import com.velthy.client.data.settings.TrackAnalysisState
import com.velthy.client.data.settings.TransitionWindow
import com.velthy.client.playback.smart.CrossfadeMode
import com.velthy.client.playback.smart.TrackAnalysis
import com.velthy.client.playback.smart.TransitionStyle
import com.velthy.client.playback.smart.TransitionTrackInfo
import com.velthy.client.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.velthy.client.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.velthy.client.playback.smart.TransitionPlan],
     ...
     * ([com.velthy.client.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.velthy.client.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.velthy.client.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.velthy.client.playback.smart.TrackAnalyzer.request] as the next
