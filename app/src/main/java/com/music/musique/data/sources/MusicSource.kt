 ...
 * [StreamResolver][com.music.musique.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.music.musique.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.music.musique.playback.QualityUpgrade.lookAgain].
 ...
 * [AppSettings][com.music.musique.data.settings.AppSettings] and is turned
