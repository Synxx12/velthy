package com.music.musique.data.discord
 ...
 *   ΓöîΓöÇΓöÇΓöÇΓöÇΓöÉ  Song title             <- details
 *   Γöéart Γöé  Artist                 <- state
 *   ΓööΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓûüΓûüΓûüΓûüΓûüΓûü 1:04 / 3:47     <- from the timestamps
 *   [ Listen on YouTube Music ]    <- button 1
 *   [ Visit Musique           ]   <- button 2
 * ```
 */
class DiscordRPC(
    val context: Context,
    ...
    companion object {
        ...
        const val PROJECT_URL = "https://github.com/Synxx12/musique-android"

        const val DEFAULT_BUTTON_1 = "Listen on YouTube Music"
        const val DEFAULT_BUTTON_2 = "Visit Musique"
