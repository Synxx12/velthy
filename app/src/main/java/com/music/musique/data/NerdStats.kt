...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.music.musique.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun declaredFormat(mediaId: String?): StreamFormat? {
        ...
        return declared[key]
            ?: com.music.musique.data.sources.SourceRegistry.parseTrackKey(key)
