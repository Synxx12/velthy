package com.music.musique.data.model
...
data class Song(
     ...
     * that need it — see [com.music.musique.playback.toMediaItem].
     */
...
data class DetailPage(
     ...
     * added — see [com.music.musique.data.innertube.InnertubeParser.parsePlaylistShelf].
