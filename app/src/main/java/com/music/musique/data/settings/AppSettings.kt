package com.music.musique.data.settings
...
object AppSettings {
     ...
     * [SourceResolver.requestForNow][com.music.musique.data.sources.SourceResolver.requestForNow] —
     ...
     * decode per track.
     *
     * See [com.music.musique.playback.smart.TransitionPlanner].
     */
    val smartFadeEnabled = MutableStateFlow(false)
    val skipSilence = MutableStateFlow(false)

    /**
     * Widens stereo output via [com.music.musique.playback.SpatialAudioProcessor],
     ...
     * with Dolby Atmos switched on, and [com.music.musique.playback.DolbyAtmos]
     ...
     * all. See [CanvasRepository][com.music.musique.data.canvas.CanvasRepository].
     */
    ...
    /** Disk budget for cached audio. [AudioCache][com.music.musique.playback.AudioCache] evicts past it. */
     ...
     * [PlaybackService][com.music.musique.playback.PlaybackService] can pick
     ...
     *
     * Musique ships sideloaded (see [com.music.musique.data.AppUpdateChecker]),
