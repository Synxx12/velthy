 ...
 * `next`-endpoint fetches, [ChunkedDataSource][com.music.musique.playback.ChunkedDataSource]
 * and [AudioCache][com.music.musique.playback.AudioCache]'s multi-megabyte
