...
import com.music.musique.playback.AudioCache
import com.music.musique.playback.DolbyAtmos
import com.music.musique.playback.LastPlayed
...
class MusiqueApplication : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        com.music.musique.data.sources.SourceRegistry.init(this)
        com.music.musique.data.history.PlaybackHistoryManager.init(this)
