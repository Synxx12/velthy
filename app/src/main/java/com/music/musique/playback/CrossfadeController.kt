...
import com.music.musique.data.settings.SmartAnalysis
import com.music.musique.data.settings.TrackAnalysisState
import com.music.musique.data.settings.TransitionWindow
import com.music.musique.playback.smart.CrossfadeMode
import com.music.musique.playback.smart.TrackAnalysis
import com.music.musique.playback.smart.TransitionStyle
import com.music.musique.playback.smart.TransitionTrackInfo
import com.music.musique.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.music.musique.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.music.musique.playback.smart.TransitionPlan],
     ...
     * ([com.music.musique.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.music.musique.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.music.musique.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.music.musique.playback.smart.TrackAnalyzer.request] as the next
