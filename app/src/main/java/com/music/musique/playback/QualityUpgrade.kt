...
import com.music.musique.data.sources.StreamRequest
...
object QualityUpgrade {
     ...
     * [PlaybackService][com.music.musique.playback.PlaybackService]'s
     * audition.
     *
     ...
     * [PlaybackService][com.music.musique.playback.PlaybackService].
     */
    ...
    /**
     * Marks [mediaId] as having completed its quality evaluation for the current playback session.
     * Prevents seeking, progress loops, or track re-opens from triggering redundant background searches.
     */
    fun markAsked(mediaId: String) {
        asked += mediaId
    }
     ...
     * lossless beats it, which is the whole point of this path.
     *
     * @param playingMime what the *decoder* says about the bytes it is being
     *   fed, and it must be this track's — see
     *   [PlaybackService.audioFormatFor][com.music.musique.playback.PlaybackService].
