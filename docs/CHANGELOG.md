...
#### ✨ Fitur Baru & Tampilan
- **Bilah Navigasi Melipat Saat Discroll (khusus Liquid Glass)**: Saat Liquid Glass aktif, bilahnya memakai bentuk baru ala iOS 26 — kontrol now playing dan tab jadi satu komponen yang **melipat bareng saat halaman digulir ke bawah**, lalu mengembang lagi saat gulirannya balik. Kalau Liquid Glass dimatikan, bilah biasa tampil seperti semula **tanpa animasi lipat**.
- **Liquid Glass untuk Bilah Navigasi & Mini Player**: Opsi baru di Pengaturan → Appearance yang mengganti kaca buram biasa dengan **kaca sungguhan** — bilah bawah dan mini player benar-benar memblur dan membiaskan halaman di belakangnya, bukan sekadar lapisan frosted. Seluruh pipeline render-nya (blur, pembiasan lensa, highlight, bayangan) ikut disertakan ke dalam aplikasi ini. Hanya tersedia di Android 12 ke atas, dan otomatis nonaktif kalau "Reduce dynamic blur" menyala.
- **Pencarian Bergaya BitChord dengan Hasil Terbagi per Bagian**: Halaman hasil pencarian kini dikelompokkan per kategori — **Songs**, **Artists**, **Albums**, **Playlists**, dan **More** — sehingga hasil campuran langsung terbaca sekilas. Sebuah kartu **Top result** berukuran besar tampil paling atas pada tab "All", lengkap dengan tombol **Play** dan **Playlist** untuk memutar lagu paling relevan atau langsung memasukkannya ke daftar putar.
- **Pilihan Filter "All" Kembali Hadir**: Deretan filter kini diawali **All** sebagai tampilan bawaan yang menyatukan semua jenis hasil, disusul **Songs**, **Albums**, **Artists**, dan **Playlists**. Pil filter tetap menempel di bawah bilah atas dan tidak ikut tergulung saat menelusuri hasil.
- **Saran Pencarian Langsung Saat Mengetik**: Saat mengetik di kolom pencarian, muncul daftar saran kata kunci dari YouTube Music. Baris paling atas selalu berupa aksi untuk mencari teks yang sedang diketik, dan setiap saran punya tombol untuk mengisinya kembali ke kolom agar bisa dilanjutkan mengetik.
- **Hasil Pencarian Tak Terbatas**: Menelusuri hasil hingga mendekati bagian bawah kini otomatis memuat halaman berikutnya, sehingga daftar tidak berhenti di layar pertama.
- **Halaman Awal Pencarian Lebih Bersih**: Saat kolom masih kosong, tab Search hanya menampilkan riwayat pencarian terakhir agar fokus tetap pada apa yang ingin dicari.
- **Background Pemutar dari Warna Sampul Sendiri**: Layar pemutar kini berdiri di atas warna yang diambil langsung dari susunan artwork-nya — bukan empat bulatan warna hasil kuantisasi. Sampul yang didominasi satu warna tetap didominasi warna itu, dan warna tepat di bawah sampul menyambung mulus dengan ujung sampulnya. Mesh gradient lama tetap tersedia sebagai pilihan di Pengaturan → **Legacy mesh gradient**, jadi tampilan lama tidak hilang.
- **Opsi Kualitas Audio Lebih Tegas**: Menu opsi lagu kini memimpin dengan satu baris kualitas audio — ikon panah balik dengan label **"Revert to original"** saat lagu diputar dari salinan pengganti, atau ikon kualitas dengan label **"Upgrade quality"** saat lagu masih dari YouTube dan versi yang lebih tinggi tersedia. Menempatkannya paling atas memastikan tidak ada yang memberi rating atau mengunduh versi lagu yang salah.
- **Halaman Sources Akhirnya Bisa Dibuka**: Halaman Sources — daftar sumber audio, modul, dan indeks kustom beserta urutannya, status keterjangkauan, dan pengaturan lossless — sebelumnya sudah ada di aplikasi tapi **tidak bisa diakses dari mana pun**. Kini ada baris **Sources** di Pengaturan → Audio quality yang membukanya, lengkap dengan dialog untuk memasang atau mengganti URL modul kustom.
- **Opsi "Don't repeat songs in current session"**: Baris pengaturan baru di grup Miscellaneous agar lagu yang sudah diputar di sesi ini tidak muncul lagi. Pengaturannya sebenarnya sudah tersimpan di aplikasi, hanya saja belum pernah ditampilkan ke pengguna.
- **Grup "Local music" dengan Filter Audio Non-Musik**: Baris baru untuk menyaring klip, nada dering, dan catatan suara dari pustaka lokal. Sebelumnya penyaringan ini dipaku mati di dalam kueri MediaStore; sekarang bisa dimatikan lewat Pengaturan kalau memang ingin seluruh audio di perangkat muncul. Bawaannya tetap **aktif**, jadi perilaku yang sekarang tidak berubah.
- **Mode Performa Tinggi + Pilihan Refresh Rate**: Grup **Performance** baru berisi sakelar **High performance mode** beserta pemilih **refresh rate** dari mode yang benar-benar didukung layar perangkat. Saat aktif, aplikasi meminta refresh rate tinggi ke sistem (bukan memaksa mode atau resolusi) dan mengembalikan animasi serta blur ke setelan penuh. Karena ini menaikkan pemakaian baterai, CPU, dan GPU, mengaktifkannya melewati dialog peringatan yang mengarahkan ke pengaturan baterai sistem, lalu konfirmasi sebelum benar-benar dinyalakan — persis alur BitChord.
- **Ketuk Avatar = Ganti Akun**: Mengetuk avatar di bilah atas kini membuka pemilih akun ringkas bergaya BitChord — daftar sesi yang tersimpan (ketuk untuk berpindah, ikon centang menandai yang sedang aktif), plus aksi **Add account**, **Manage accounts** (untuk keluar dari akun tertentu), dan **Settings**. Sebelumnya avatar langsung membuang pengguna ke halaman Pengaturan.
- **Opsi "Blur unfocused lyrics"**: Baris baru di grup lirik untuk menajamkan hanya baris yang sedang dinyanyikan sementara baris lain diburamkan. Efek blur-nya sudah ada di pemutar sejak dulu, tapi tidak pernah bisa dimatikan; sekarang jadi pilihan, dengan bawaan **aktif** seperti sebelumnya.
- **Pilih Channel YouTube yang Dipakai**: Satu login Google bisa memiliki beberapa channel YouTube, dan kini kamu bisa memilih ingin mendengarkan sebagai channel yang mana. Pilihan itu menentukan pustaka, lagu yang disukai, dan riwayat yang tampil, serta disimpan per akun sehingga tetap tersimpan saat berpindah akun.
- **Kartu Akun Lebih Bersih**: Kartu akun kini hanya menampilkan foto profil, nama, dan handle. Ikon centang pada foto dan tombol Log out di kartu dihapus; keluar akun dipindah ke barisnya sendiri.
- **Ganti Profil YouTube dari Dalam Aplikasi**: Opsi untuk memilih profil kini membuka YouTube Music dengan sesi yang sudah ada, sehingga kamu bisa memakai pemilih akun milik YouTube Music lalu menekan **Use this profile** untuk memakai profil yang sedang tampil.
- **Dolby Atmos**: Opsi baru di Pengaturan → Audio quality untuk memakai versi Dolby Atmos bila sumber menyediakannya. Perangkat tanpa dekoder Dolby otomatis menonaktifkan opsi ini, dan aplikasi hanya meminta versi Atmos setelah memastikan perangkat mampu memutarnya.
- **Output Precision**: Opsi baru di Pengaturan → Playback untuk memilih keluaran **16-bit PCM** atau **32-bit float**. Mode float hanya dipakai pada rute audio eksternal yang dipilih pengguna dan melaporkan dukungannya; selain itu keluaran tetap 16-bit. Bawaannya 16-bit PCM.
- **Prefer USB DAC**: Opsi baru di Pengaturan → Playback untuk mengarahkan pemutaran ke DAC USB yang terpasang — termasuk bila DAC dicolok saat lagu sedang berputar. Barisnya menandai **Connected** bila suara memang keluar lewat DAC USB.
- **Automix Performance**: Opsi baru di Pengaturan → Playback untuk mengatur beban CPU analisis Automix: **Efficient**, **Balanced**, atau **Performance**. Sebelumnya beban ini tetap untuk semua perangkat. Bawaannya Balanced.
- **Export Compatible Downloads**: Opsi baru di Pengaturan → Downloads untuk menyimpan salinan setiap unduhan di folder **Music/Velthy**, sehingga berkasnya mudah ditemukan dan diputar aplikasi lain. Menyalakannya sekaligus menyalin unduhan yang sudah ada; mematikannya tidak menghapus berkas apa pun.
- **Bagian Audio Quality**: Grup ini kini berisi Sources, On Wi-Fi, On mobile data, dan Dolby Atmos. Pilihan **Lossless** ditambahkan ke daftar kualitas per koneksi, dan dua pengaturan lossless yang terpisah dihapus karena pertanyaan yang sama kini dijawab oleh kualitas koneksi itu sendiri.
- **Statistik di Halaman Artis**: Halaman artis kini menampilkan jumlah subscriber dan pendengar bulanan di bawah nama artis.
- **Deskripsi Artis**: Halaman artis kini menampilkan bagian **About the artist** berisi deskripsi artis dari YouTube Music.
- **Urutan Pengaturan Ditata Ulang**: Grup di halaman Pengaturan kini berurutan Audio quality, Downloads, Playback, Appearance, Performance, Local music, Storage, Your data, dan Miscellaneous, sehingga bagian yang berhubungan berdekatan.
- **Layar Sources**: Daftar sumber audio kini tampil paling atas, dengan pengaturan kualitas suara di bawahnya.
- **Urutan Sumber Bisa Diatur dengan Geser**: Sumber yang kamu tambahkan sendiri di layar Sources kini punya pegangan untuk digeser naik atau turun, dan urutan hasil geseran itu yang benar-benar dipakai saat memutar — sumber tambahan dicoba lebih dulu. Sumber bawaan (module bawaan, JioSaavn, YouTube) menempati urutan tetap sesuai jenisnya. Urutannya tersimpan begitu jari dilepas dan bertahan antar sesi.
- **Editor Sumber Bergaya Kartu**: Menambah atau mengubah sumber kini memakai kartu mengambang yang sama dengan dialog lain di aplikasi, dengan satu kolom alamat dan aksi **Test**, **Save**, **Remove**, dan **Cancel** yang bertumpuk. Hasil pengujian menggantikan keterangan di tempatnya, jadi alamat yang salah langsung terbaca.
- **Saran Pencarian Plus Daftar Lagu**: Saat mengetik di pencarian, di bawah saran kata kunci kini muncul daftar singkat lagu yang cocok, seperti di Apple Music. Mengetuk salah satunya langsung memutarnya, tanpa harus membuka halaman hasil.
- **Grup Lossless di Layar Sources**: Layar Sources kini dipimpin grup **Lossless audio** dengan sakelar **Prefer lossless**. Sakelar ini bisa mematikan permintaan lossless sepenuhnya; berkas asli baru diminta bila kualitas untuk koneksi yang sedang dipakai juga diatur ke Lossless, dan bila tidak, batas koneksi yang menang.
- **Tambah Beberapa Modul Kustom**: Baris di layar Sources kini **menambah** indeks baru alih-alih menimpa yang lama, sehingga beberapa modul bisa dipasang dan dipakai sekaligus. Setiap modul bisa diketuk untuk diuji, diubah, atau dihapus sendiri.
- **Output Precision Lebih Ringkas**: Pilihan **16-bit PCM** dan **32-bit float** kini tampil sebagai dua segmen yang bisa langsung ditekan di bawah barisnya, bukan lagi tersembunyi di balik dialog.
- **Automix Performance dengan Panel Pilihan**: Pilihan **Efficient**, **Balanced**, dan **Performance** kini muncul sebagai panel dari bawah, lengkap dengan penjelasan singkat tiap opsi dan tanda centang pada yang sedang dipakai.
- **Ikon Dolby Atmos Resmi**: Baris Dolby Atmos kini memakai lambang Dolby yang sebenarnya, bukan ikon gelombang generik.
- **Album di Kartu Discord**: Kartu aktivitas Discord kembali menampilkan tiga baris — judul lagu, artis, dan album. Sebelumnya album digabung ke baris artis sehingga tidak pernah tampil sebagai barisnya sendiri. Opsi "Second line" diganti satu sakelar **Album line**, dan pratinjau di layar Discord ikut menampilkan tiga baris sesuai yang dikirim.

#### ⚡ Peningkatan Kualitas & Performa
- **Pencarian Hanya Dijalankan Saat Diminta**: Mengetik tidak lagi memicu satu permintaan pencarian penuh untuk setiap huruf — setiap ketikan kini hanya meminta saran yang jauh lebih ringan. Pencarian penuh dijalankan sekali saat kata kunci sudah pasti (menekan tombol cari di keyboard, atau memilih saran/riwayat), sehingga lebih hemat data dan koneksi lebih stabil.
- **Menggulir Lebih Ringan**: Efek kaca pada bilah pemutar, pil tab, dan kabut di tepi atas dan bawah layar kini diproses pada resolusi lebih rendah, sehingga menggulir terasa jauh lebih ringan tanpa perubahan tampilan yang terlihat.

#### 🐛 Perbaikan Masalah
- **Aplikasi Tidak Lagi Tertutup Paksa Saat Memakai Sumber Modul**: Memperbaiki crash native (SIGABRT) dari mesin JavaScript yang menjalankan modul. Sebelumnya satu mesin dibuat per modul lalu di-evict dan ditutup tanpa pengaman, sementara panggilan lain bisa masih berjalan di dalamnya — mesin yang ditutup di bawah kaki pemanggilnya membuat referensi JNI jadi tidak valid dan aplikasi mati mendadak. Kini tiap modul memakai kolam mesin kecil yang dipakai satu pemanggil sekaligus, setiap penutupan mesin dibungkus pengaman, dan pengelolaan mesinnya diserialisasi.
- **Sampul Tidak Lagi Meloncat Saat Membuka Lirik**: Membuka panel lirik dulu menyentak sampul ke ukuran thumbnail dalam satu frame, sementara bannernya masih memudar selama 420ms — separuh artwork meloncat, separuhnya meluncur menyusul, dan keduanya terbaca patah. Kini sampul dan banner mengecil dengan satu animasi yang sama, baik saat membuka antrean maupun lirik, sehingga gerakannya konsisten dan mulus.
- **Lirik Tetap Terbaca dan Tetap Sinkron Saat Digulir**: Menggulir panel lirik dulu membuat semua baris menyala putih penuh sekaligus — bagian yang sudah dinyanyikan dan yang belum jadi tak terbeda, dan sorotan baris yang sedang berjalan ikut hilang. Kini saat digulir teks tetap terbaca dengan sapuan kata yang masih mengikuti lagu: baris yang sudah lewat tetap terang, yang belum tetap redup, dan hanya baris aktif yang paling menonjol — tanpa efek pendar, yang memang hanya untuk saat lagu diputar.
- **Channel Brand Kini Benar-Benar Dipakai**: Sebelumnya aplikasi selalu meminta data sebagai identitas pertama dari login, sehingga akun yang musiknya berada di channel brand melihat pustaka, lagu yang disukai, dan riwayat milik channel yang salah. Kini permintaan benar-benar dikirim sebagai channel yang dipilih.
- **Menambah Akun Baru Tidak Lagi Kembali ke Akun Lama**: Menambah akun dulu langsung mengembalikan akun yang sedang aktif, dan dari halaman Akun pemilih akun bahkan tidak pernah muncul. Kini semua jalur masuk menampilkan pemilih akun Google, sehingga akun baru bisa ditambahkan dengan benar.
- **Tombol Suka Kini Tersalin ke Notifikasi**: Menekan tombol suka di layar pemutar langsung mengubah ikon hati di notifikasi, dan sebaliknya. Sebelumnya keduanya menyimpan status masing-masing sehingga tidak pernah cocok.
- **Akun Pertama Tidak Lagi Ter-logout Saat Menambah Akun Kedua**: Menambah akun dulu memaksa keluar dari sesi Google di browser bawaan aplikasi, sehingga akun yang sudah tersimpan ikut berhenti bisa dipakai. Kini sesi akun pertama tetap utuh, dan sesi yang sedang aktif selalu disimpan lebih dulu sebelum diganti.
- **Judul Panjang Kini Berjalan**: Judul yang tidak muat bergerak perlahan sampai habis, berhenti sejenak, lalu mengulang, sementara judul pendek tetap diam. Berlaku di bilah pemutar biasa, bilah Liquid Glass, dan layar pemutar penuh — yang sebelumnya hanya memotong judul.
- **Spatial Audio Kini Berdiri Sendiri**: Sebelumnya efek pelebar stereo baru menyala bila sakelar Dolby Atmos di pengaturan sistem perangkat juga menyala. Kini efeknya menyala murni dari pengaturan di aplikasi.
- **Album Muncul di Mana Pun Lagu Diputar**: Baris album di kartu Discord sebelumnya hanya muncul bila lagu diputar dari Home. Kini album ikut terbawa saat lagu video ditukar dengan versi katalog resminya, dan album juga dicari saat lagu diputar ketika barisnya sendiri tidak menyebutkannya — seperti hasil pencarian dan baris playlist — sehingga baris album muncul dari titik mana pun.
- **Album Tersampaikan ke Kartu Discord**: Baris album di kartu Discord sebelumnya hilang sebelum terkirim — saat lagu diserahkan ke pemutar, saat kartu Home disusun, dan pada lagu yang diputar dari halaman album. Ketiganya sudah diperbaiki.
- **Dolby Atmos Kini di Grup Audio Quality**: Opsi Dolby Atmos sebelumnya tampil di grup Downloads. Kini berada di grup Audio quality, sebagai baris terakhir setelah pilihan kualitas koneksi.
- **Export Compatible Downloads Lebih Rapi**: Baris ini kini menyatu dengan pengaturan unduhan di atasnya, sehingga lencana folder tujuannya tidak lagi berdesakan dengan judul panjang.
...
- **Foto Profil Discord Kini Selalu Berbentuk Kotak**: Memperbaiki bug di mana sampul lagu di Rich Presence Discord tampil dengan bar hitam di atas dan bawah (*letterbox*) karena menggunakan thumbnail video YouTube berformat 4:3. Pemutar kini secara cerdas memprioritaskan thumbnail kotak (*square*) langsung dari YouTube Music — hasil yang jauh lebih bersih dan profesional di profil Discord.

#### ✨ Fitur Baru & Tampilan
- **Animasi Morph Cover Seamless (Mini → Full Player)**: Sampul lagu kini "terbang" secara halus dari posisi mini player menuju layar penuh saat pemutar dibuka — transisi yang kontinu dan mengikuti jari, bukan sekadar fade biasa.
- **Geser ke Atas untuk Buka Pemutar dari Mini Player**: Selain mengetuk, kini pengguna dapat menggeser mini player ke atas untuk membuka layar pemutar penuh secara intuitif.
